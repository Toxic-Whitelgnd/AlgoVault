...
"password": "rammohan"
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const response = await axios.post('https://localhost:7250/api/LoginSignup/register', JSON.stringify(formData),
				{
					headers: {
				...
				<div class="inner">
					...
					<form action="" method='post' onSubmit={handleSubmit}>
						...
						<div class="form-holder">
							...
							<input type="text" name="phone" value={formData.phone} onChange={handleChange} class="form-control" placeholder="Phone Number" />
						</div>
						<div class="form-holder">
